...
const NSString * global_bundleIdentifier = @"OEPL.COMLEX-LEVEL-2-PE";
...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    if(firstwindowController == nil)
    {
        [firstwindowController release];
        firstwindowController = [[FirstWindowController alloc] initWithWindowNibName:@"FirstWindowController"];
    }
    ...
    [[welcomeWindow window] setLevel:NSScreenSaverWindowLevel + 1];
    [[welcomeWindow window] orderFront:nil];
    
    NSUserDefaults *prefs = [NSUserDefaults standardUserDefaults];
    NSString *myString = [prefs stringForKey:@"keyToLookupString"];
    
    if ([myString isEqualToString:@"On1"]) {
...
*/
/**
    Returns the directory the application uses to store the Core Data store file. This code uses a directory named "COMLEX_LEVEL_2_PE" in the user's Library directory.
 */
- (NSURL *)applicationFilesDirectory {

    NSFileManager *fileManager = [NSFileManager defaultManager];
    NSURL *libraryURL = [[fileManager URLsForDirectory:NSLibraryDirectory inDomains:NSUserDomainMask] lastObject];
    return [libraryURL URLByAppendingPathComponent:@"COMLEX_LEVEL_2_PE"];
}
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"COMLEX_LEVEL_2_PE" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *url = [applicationFilesDirectory URLByAppendingPathComponent:@"COMLEX_LEVEL_2_PE.storedata"];
